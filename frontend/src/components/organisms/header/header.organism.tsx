  ...
  return (
    <nav className="px-2 p-4 bg-gray-200 border-gray-200  dark:shadow-none dark:bg-gray-800 dark:border-gray-700">
      <div className="container flex flex-wrap justify-between items-center mx-auto">
        ...
        >
          <ul className="flex flex-col bg-gray-200 rounded-lg border border-gray-100 md:flex-row md:space-x-2 md:mt-0 md:text-sm md:font-medium md:border-0 dark:bg-gray-800 dark:border-gray-700">
            <li>
